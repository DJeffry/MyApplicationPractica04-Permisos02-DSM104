    ...
    private fun configurarPermisos(){
        ...
        if (permission != PackageManager.PERMISSION_GRANTED) {
            ...
            if
                ...
                builder.setMessage("Permiso para acceder al microfono es requerido por esta App para grabar audio.").setTitle("Permission required")
...
/* Escribir Cédigo de Permiso Denegado, segt'm se requiera */
                } else {
                    Log.i(TAG, "Permiso concedido por el usuario")
                    Toast.makeText(applicationContext,"Permiso concedido por el usuario",
                        Toast.LENGTH_SHORT).show()
/* Escribir Cédigo de Permiso Concedido, segl'ul se requiera */
                }
            }
        }
    }
